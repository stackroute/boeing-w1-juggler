...
public class InvitationController {
	...
	@Autowired
	public InvitationController(RsvpInvitationServiceImpl rsvpInvitationServiceImpl, RsvpCreateServiceImpl rsvpCreateServiceImpl, RSVPEventStreams rsvpEventStreams, Environment env) {
		super();
	...
	public ResponseEntity<?> saveInvitation(@RequestBody Invitation rsvpInvitation)
	{
		...
		return new ResponseEntity<Invitation>(rsvpInvitationServiceImpl.saveRsvpInvitation(rsvpInvitation),HttpStatus.CREATED);
	}
	
	@GetMapping("/invitations")
	public ResponseEntity<?> getAllInvitations()
	{
		return new ResponseEntity<Iterable<Invitation>>(rsvpInvitationServiceImpl.getAllRsvpInvitation(),HttpStatus.OK);
	}
	
	@GetMapping("/invitation/{invitationId}")
	public ResponseEntity<?> getInvitationById(@PathVariable int invitationId)
	{
		return new ResponseEntity<Optional<Invitation>>(rsvpInvitationServiceImpl.getRsvpInvitationByInvitationId(invitationId),HttpStatus.OK);
	}
	...
	{
		return new ResponseEntity<Invitation>(rsvpInvitationServiceImpl.updateRsvpInvitation(rsvpInvitation, invitationId),HttpStatus.OK);
	}
}
